...
from models import Player, Quest, PlayerQuest, Achievement, PlayerAchievement, CustomTitle, PlayerTitle, GradientTheme, PlayerGradientSetting, SiteTheme, ShopItem, ShopPurchase, Clan, ClanMember, Tournament, TournamentParticipant
import os
import csv
import io
...
def purchase_item(item_id):
    ...
    try:
        ...
        flash(f'Успешно куплено: {item.display_name}!', 'success')
